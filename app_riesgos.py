...
st.set_page_config(
     page_title = 'Risk Score App',
     layout = 'wide')

#SIDEBAR
with st.sidebar:
    st.image('risk_scoring.png')
    ...
    ingresos = st.slider('Ingresos anuales', 15000, 300000)
    antigüedad_empleo = st.selectbox('Antigüedad en el empleo', ['desconocido','< 1 year','1 year','2 years','3 years','4 years',
                           '5 years','6 years','7 years','8 years','9 years','10+ years'])
    vivienda = st.radio('Vivienda',['MORTGAGE','RENT','OWN'])
